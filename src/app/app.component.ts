...
export class MyApp {
  ...
  constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen, public sessionService: SessionService, private androidPermissions: AndroidPermissions, private oneSignal: OneSignal) {
    this.initializeApp();
